""" T5 (Seq-2-Seq) Encoder/Decoder Transformer
    We tuned this model on the Funcom Dataset, using ROUGE-1 evaluation.
...
baseName = "t5-small"
metricName = "rouge"
outputDir = "./Exp1-FuncomDataset-Results-R1"
...
# ------------------------------- Save Model ----------------------------------
    if result["ROUGE-1"] > previousValidationResult:  # Don't kill best model.
        previousValidationResult = result["ROUGE-1"]

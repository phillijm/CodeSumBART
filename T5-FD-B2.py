""" T5 (Seq-2-Seq) Encoder/Decoder Transformer
    We tuned this model on the Funcom Dataset, using BLEU-2 evaluation.
...
baseName = "t5-small"
metricName = "bleu"
outputDir = "./Exp1-FuncomDataset-Results-B2"
...
# ------------------------------- Save Model ----------------------------------
    if result["BLEU-2"] > previousValidationResult:  # Don't kill best model.
        previousValidationResult = result["BLEU-2"]

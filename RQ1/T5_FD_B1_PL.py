""" T5 (Seq-2-Seq) Encoder/Decoder Transformer using PyTorch Lightning.
...
class AdamWT5BleuModel(pl.LightningModule):
    ...
    def __init__(self, model: str, *args: tuple, **kwargs: dict) -> None:
        ...
        """
        super(AdamWT5BleuModel, self).__init__()
...
if __name__ == '__main__':
    ...
    model = AdamWT5BleuModel(model=base,
                             use_stemmer=True,

...
class AdamWBARTBERTScoreModel(pl.LightningModule):
    ...
    def __init__(self, model: str, *args: tuple, **kwargs: dict) -> None:
        ...
        """
        super(AdamWBARTBERTScoreModel, self).__init__()
...
if __name__ == '__main__':
    ...
    checkpointCallback = ModelCheckpoint(monitor="val_bs",
                                         save_top_k=3,
                                         mode="max",
    ...
    model = AdamWBARTBERTScoreModel(model=base,
                                    use_stemmer=True,
